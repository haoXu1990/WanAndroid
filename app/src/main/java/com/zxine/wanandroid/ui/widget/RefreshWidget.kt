...
fun <T: Any> RefreshWidget(
    ...
    SwipeRefresh(
        ...
        rememberSwipeRefreshState.isRefreshing = (lazyPagingItems.loadState.refresh is LoadState.Loading) || isRefreshing
                    ...
                    lazyPagingItems.apply {
                        when (loadState.append) {
                            ...
                            is LoadState.NotLoading -> {
                                if (loadState.append.endOfPaginationReached) NoMoreItem()
                            }
                        }
                    }
                }
